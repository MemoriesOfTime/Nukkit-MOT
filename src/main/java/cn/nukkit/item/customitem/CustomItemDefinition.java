...
public class CustomItemDefinition {
    ...
    public static class ToolBuilder extends SimpleBuilder {
        ...
        public ToolBuilder addRepairItemName(@NonNull String repairItemName, String molang) {
            super.addRepairs(Arrays.asList(repairItemName), molang);
            return this;
        }

        public ToolBuilder addRepairItemName(@NonNull String repairItemName, int repairAmount) {
            super.addRepairs(Arrays.asList(repairItemName), String.valueOf(repairAmount));
            return this;
        }

        public ToolBuilder addRepairItems(@NotNull List<Item> repairItems, String molang) {
            super.addRepairs((List<String>) repairItems.stream().map(Item::getNamespaceId), molang);
            return this;
        }

        public ToolBuilder addRepairItems(@NotNull List<Item> repairItems, int repairAmount) {
            super.addRepairs((List<String>) repairItems.stream().map(Item::getNamespaceId), String.valueOf(repairAmount));
            return this;
        }
        ...
        public CustomItemDefinition build() {
            ...
            if (item.isPickaxe()) {
                //添加可挖掘方块Tags
                this.blockTags.addAll(Arrays.asList("'stone'", "'metal'", "'diamond_pick_diggable'", "'mob_spawner'", "'rail'", "'slab_block'", "'stair_block'", "'smooth stone slab'", "'sandstone slab'", "'cobblestone slab'", "'brick slab'", "'stone bricks slab'", "'quartz slab'", "'nether brick slab'"));
                //添加可挖掘方块
                ...
                this.blockTags.addAll(Arrays.asList("'wood'", "'pumpkin'", "'plant'"));
                type = ItemTag.IS_AXE;
                this.nbt.getCompound("components").getCompound("item_properties")
                ...
                this.blockTags.addAll(Arrays.asList("'sand'", "'dirt'", "'gravel'", "'grass'", "'snow'"));
