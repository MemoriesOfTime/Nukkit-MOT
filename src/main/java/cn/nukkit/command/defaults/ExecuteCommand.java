        ...
        switch (result.getKey()) {
            ...
            case "at" -> {
                ...
                for (Location location : locations) {
                    ...
                    num += executorCommandSender.getServer().dispatchCommand(executorCommandSender, chainCommand) ? 1 : 0;
                }
                return num;
            }
            case "in" -> {
                ...
                ExecutorCommandSender executorCommandSender = new ExecutorCommandSender(sender, sender.asEntity(), location);
                return executorCommandSender.getServer().dispatchCommand(executorCommandSender, chainCommand) ? 1 : 0;
            }
            case "facing" -> {
            ...
            case "if-unless-block" -> {
                ...
                if (list.hasResult(4) && condition) {
                    String chainCommand = list.getResult(4);
                    return sender.getServer().dispatchCommand(sender, chainCommand) ? 1 : 0;
                } else if (condition) {
            ...
            case "if-unless-score-matches" -> {
                ...
                if (range.contains("..")) {
                    ...
                    var splittedScoreScope = Utils.fastSplit(SCORE_SCOPE_SEPARATOR, range);
