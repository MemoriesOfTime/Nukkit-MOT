    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        if (!((Player) target).setGamemode(gameMode)) {
            ...
            if (target.equals(sender)) {
                broadcastCommandMessage(sender, new TranslationContainer("commands.gamemode.success.self", Server.getGamemodeString(gameMode)));
            } else {
                target.sendMessage(new TranslationContainer("gameMode.changed"));
                broadcastCommandMessage(sender, new TranslationContainer("commands.gamemode.success.other", target.getName(), Server.getGamemodeString(gameMode)));
            }
        }
