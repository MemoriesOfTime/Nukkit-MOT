...
public class LoomTransaction extends InventoryTransaction {
    ...
    public boolean canExecute() {
        ...
        if (pattern.getId() != 0 && (pattern.getId() != ItemID.BANNER_PATTERN && !pattern.getNamespaceId().equals("minecraft:guster_banner_pattern") && !pattern.getNamespaceId().equals("minecraft:flow_banner_pattern"))) {
            return false;
        }
