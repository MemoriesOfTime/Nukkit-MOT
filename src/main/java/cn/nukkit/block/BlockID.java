...
public interface BlockID {
    ...
    int SULFUR = 1347;
    int SULFUR_SLAB = 1348;
    int SULFUR_DOUBLE_SLAB = 1349;
    int SULFUR_STAIRS = 1350;
    int SULFUR_WALL = 1351;
    int POLISHED_SULFUR = 1352;
    int POLISHED_SULFUR_SLAB = 1353;
    int POLISHED_SULFUR_DOUBLE_SLAB = 1354;
    int POLISHED_SULFUR_STAIRS = 1355;
    int POLISHED_SULFUR_WALL = 1356;
    int SULFUR_BRICKS = 1357;
    int SULFUR_BRICK_SLAB = 1358;
    int SULFUR_BRICK_DOUBLE_SLAB = 1359;
    int SULFUR_BRICK_STAIRS = 1360;
    int SULFUR_BRICK_WALL = 1361;
    int CHISELED_SULFUR = 1362;
    int POTENT_SULFUR = 1363;
    int CINNABAR = 1364;
    int CINNABAR_SLAB = 1365;
    int CINNABAR_DOUBLE_SLAB = 1366;
    int CINNABAR_STAIRS = 1367;
    int CINNABAR_WALL = 1368;
    int POLISHED_CINNABAR = 1369;
    int POLISHED_CINNABAR_SLAB = 1370;
    int POLISHED_CINNABAR_DOUBLE_SLAB = 1371;
    int POLISHED_CINNABAR_STAIRS = 1372;
    int POLISHED_CINNABAR_WALL = 1373;
    int CINNABAR_BRICKS = 1374;
    int CINNABAR_BRICK_SLAB = 1375;
    int CINNABAR_BRICK_DOUBLE_SLAB = 1376;
