...
public class DebugLine extends DebugShape {
    ...
    public DebugLine(long id, int dimension, @Nullable Vector3f position, @Nullable Float scale, @Nullable Vector3f rotation, @Nullable Float totalTimeLeft, @Nullable Color color, Vector3f lineEndPosition) {
        this(id, dimension, position, scale, rotation, totalTimeLeft, null, color, lineEndPosition);
    }

    public DebugLine(long id, int dimension, @Nullable Vector3f position, @Nullable Float scale, @Nullable Vector3f rotation, @Nullable Float totalTimeLeft, @Nullable Float maximumRenderDistance, @Nullable Color color, Vector3f lineEndPosition) {
