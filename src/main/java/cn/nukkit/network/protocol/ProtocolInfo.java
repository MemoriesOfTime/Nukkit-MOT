...
public interface ProtocolInfo {
    ...
    ImmutableMap<Class<? extends DataPacket>, Byte> ProtocolInfo18 = ImmutableMap.<Class<? extends DataPacket>, Byte>builder()
        .put(LoginPacket.class, (byte) 0x82)
        .put(PlayStatusPacket.class, (byte) 0x83)
        .put(DisconnectPacket.class, (byte) 0x15)
        .put(TextPacket.class, (byte) 0x85)
        .put(SetTimePacket.class, (byte) 0x86)
        .put(StartGamePacket.class, (byte) 0x87)
        .put(AddMobPacket.class, (byte) 0x88)
        .put(AddPlayerPacket.class, (byte) 0x89)
        .put(RemovePlayerPacket.class, (byte) 0x8a)
        .put(AddEntityPacket.class, (byte) 0x8c)
        .put(RemoveEntityPacket.class, (byte) 0x8d)
        .put(AddItemEntityPacket.class, (byte) 0x8e)
        .put(TakeItemEntityPacket.class, (byte) 0x8f)
        .put(MoveEntityAbsolutePacket.class, (byte) 0x90)
        .put(MoveEntityPosRotPacket.class, (byte) 0x93)
        .put(RotateHeadPacket.class, (byte) 0x94)
        .put(MovePlayerPacket.class, (byte) 0x95)
        .put(RemoveBlockPacket.class, (byte) 0x97)
        .put(UpdateBlockPacket.class, (byte) 0x98)
        .put(AddPaintingPacket.class, (byte) 0x99)
        .put(ExplodePacket.class, (byte) 0x9a)
        .put(LevelEventPacket.class, (byte) 0x9b)
        .put(BlockEventPacket.class, (byte) 0x9c)
        .put(EntityEventPacket.class, (byte) 0x9d)
        .put(MobEquipmentPacket.class, (byte) 0xa0)
        .put(MobArmorEquipmentPacket.class, (byte) 0xa1)
        .put(InteractPacket.class, (byte) 0xa2)
        .put(UseItemPacket.class, (byte) 0xa3)
        .put(PlayerActionPacket.class, (byte) 0xa4)
        .put(HurtArmorPacket.class, (byte) 0xa6)
        .put(SetEntityDataPacket.class, (byte) 0xa7)
        .put(SetEntityMotionPacket.class, (byte) 0xa8)
        .put(SetEntityLinkPacket.class, (byte) 0xa9)
        .put(SetHealthPacket.class, (byte) 0xaa)
        .put(SetSpawnPositionPacket.class, (byte) 0xab)
        .put(AnimatePacket.class, (byte) 0xac)
        .put(RespawnPacket.class, (byte) 0xad)
        .put(DropItemPacket.class, (byte) 0xaf)
        .put(ContainerOpenPacket.class, (byte) 0xb0)
        .put(ContainerClosePacket.class, (byte) 0xb1)
        .put(ContainerSetSlotPacket.class, (byte) 0xb2)
        .put(ContainerSetDataPacket.class, (byte) 0xb3)
        .put(ContainerSetContentPacket.class, (byte) 0xb4)
        .put(AdventureSettingsPacket.class, (byte) 0xb7)
        .put(BlockEntityDataPacket.class, (byte) 0xb8)
        .put(PlayerInputPacket.class, (byte) 0xb9)
        .put(LevelChunkPacket.class, (byte) 0xba)
        .put(SetDifficultyPacket.class, (byte) 0xbc)
        .put(UnloadChunkPacket.class, (byte) 0xbb)
        .build();

    ImmutableMap<Class<? extends DataPacket>, Byte> ProtocolInfo27 = ImmutableMap.<Class<? extends DataPacket>, Byte>builder()
        .put(LoginPacket.class, (byte) 0x82)
        .put(PlayStatusPacket.class, (byte) 0x83)
        .put(DisconnectPacket.class, (byte) 0x15)
        .put(BatchPacket.class, (byte) 0xb1)
        .put(TextPacket.class, (byte) 0x85)
        .put(SetTimePacket.class, (byte) 0x86)
        .put(StartGamePacket.class, (byte) 0x87)
        .put(AddPlayerPacket.class, (byte) 0x88)
        .put(RemovePlayerPacket.class, (byte) 0x89)
        .put(AddEntityPacket.class, (byte) 0x8a)
        .put(RemoveEntityPacket.class, (byte) 0x8b)
        .put(AddItemEntityPacket.class, (byte) 0x8c)
        .put(TakeItemEntityPacket.class, (byte) 0x8d)
        .put(MoveEntityAbsolutePacket.class, (byte) 0x8e)
        .put(MovePlayerPacket.class, (byte) 0x8f)
        .put(RemoveBlockPacket.class, (byte) 0x90)
        .put(UpdateBlockPacket.class, (byte) 0x91)
        .put(AddPaintingPacket.class, (byte) 0x92)
        .put(ExplodePacket.class, (byte) 0x93)
        .put(LevelEventPacket.class, (byte) 0x94)
        .put(BlockEventPacket.class, (byte) 0x95)
        .put(EntityEventPacket.class, (byte) 0x96)
        .put(MobEffectPacket.class, (byte) 0x97)
        .put(MobEquipmentPacket.class, (byte) 0x98)
        .put(MobArmorEquipmentPacket.class, (byte) 0x99)
        .put(InteractPacket.class, (byte) 0x9a)
        .put(UseItemPacket.class, (byte) 0x9b)
        .put(PlayerActionPacket.class, (byte) 0x9c)
        .put(HurtArmorPacket.class, (byte) 0x9d)
        .put(SetEntityDataPacket.class, (byte) 0x9e)
        .put(SetEntityMotionPacket.class, (byte) 0x9f)
        .put(SetEntityLinkPacket.class, (byte) 0xa0)
        .put(SetHealthPacket.class, (byte) 0xa1)
        .put(SetSpawnPositionPacket.class, (byte) 0xa2)
        .put(AnimatePacket.class, (byte) 0xa3)
        .put(RespawnPacket.class, (byte) 0xa4)
        .put(DropItemPacket.class, (byte) 0xa5)
        .put(ContainerOpenPacket.class, (byte) 0xa6)
        .put(ContainerClosePacket.class, (byte) 0xa7)
        .put(ContainerSetSlotPacket.class, (byte) 0xa8)
        .put(ContainerSetDataPacket.class, (byte) 0xa9)
        .put(ContainerSetContentPacket.class, (byte) 0xaa)
        .put(AdventureSettingsPacket.class, (byte) 0xac)
        .put(BlockEntityDataPacket.class, (byte) 0xad)
        .put(PlayerInputPacket.class, (byte) 0xae)
        .put(LevelChunkPacket.class, (byte) 0xaf)
        .put(SetDifficultyPacket.class, (byte) 0xb0)
        .put(TransferPacket.class, (byte) 0x1b)
        .build();

    ImmutableMap<Class<? extends DataPacket>, Byte> ProtocolInfo70 = ImmutableMap.<Class<? extends DataPacket>, Byte>builder()
        .put(LoginPacket.class, (byte) 0x8f)
        .put(PlayStatusPacket.class, (byte) 0x90)
        .put(DisconnectPacket.class, (byte) 0x91)
        .put(BatchPacket.class, (byte) 0x92)
        .put(TextPacket.class, (byte) 0x93)
        .put(SetTimePacket.class, (byte) 0x94)
        .put(StartGamePacket.class, (byte) 0x95)
        .put(AddPlayerPacket.class, (byte) 0x96)
        .put(RemovePlayerPacket.class, (byte) 0x97)
        .put(AddEntityPacket.class, (byte) 0x98)
        .put(RemoveEntityPacket.class, (byte) 0x99)
        .put(AddItemEntityPacket.class, (byte) 0x9a)
        .put(TakeItemEntityPacket.class, (byte) 0x9b)
        .put(MoveEntityAbsolutePacket.class, (byte) 0x9c)
        .put(MovePlayerPacket.class, (byte) 0x9d)
        .put(RemoveBlockPacket.class, (byte) 0x9e)
        .put(UpdateBlockPacket.class, (byte) 0x9f)
        .put(AddPaintingPacket.class, (byte) 0xa0)
        .put(ExplodePacket.class, (byte) 0xa1)
        .put(LevelEventPacket.class, (byte) 0xa2)
        .put(BlockEventPacket.class, (byte) 0xa3)
        .put(EntityEventPacket.class, (byte) 0xa4)
        .put(MobEffectPacket.class, (byte) 0xa5)
        .put(UpdateAttributesPacket.class, (byte) 0xa6)
        .put(MobEquipmentPacket.class, (byte) 0xa7)
        .put(MobArmorEquipmentPacket.class, (byte) 0xa8)
        .put(InteractPacket.class, (byte) 0xa9)
        .put(UseItemPacket.class, (byte) 0xaa)
        .put(PlayerActionPacket.class, (byte) 0xab)
        .put(HurtArmorPacket.class, (byte) 0xac)
        .put(SetEntityDataPacket.class, (byte) 0xad)
        .put(SetEntityMotionPacket.class, (byte) 0xae)
        .put(SetEntityLinkPacket.class, (byte) 0xaf)
        .put(SetHealthPacket.class, (byte) 0xb0)
        .put(SetSpawnPositionPacket.class, (byte) 0xb1)
        .put(AnimatePacket.class, (byte) 0xb2)
        .put(RespawnPacket.class, (byte) 0xb3)
        .put(DropItemPacket.class, (byte) 0xb4)
        .put(ContainerOpenPacket.class, (byte) 0xb5)
        .put(ContainerClosePacket.class, (byte) 0xb6)
        .put(ContainerSetSlotPacket.class, (byte) 0xb7)
        .put(ContainerSetDataPacket.class, (byte) 0xb8)
        .put(ContainerSetContentPacket.class, (byte) 0xb9)
        .put(CraftingDataPacket.class, (byte) 0xba)
        .put(CraftingEventPacket.class, (byte) 0xbb)
        .put(AdventureSettingsPacket.class, (byte) 0xbc)
        .put(BlockEntityDataPacket.class, (byte) 0xbd)
        .put(PlayerInputPacket.class, (byte) 0xbe)
        .put(LevelChunkPacket.class, (byte) 0xbf)
        .put(SetDifficultyPacket.class, (byte) 0xc0)
        .put(ChangeDimensionPacket.class, (byte) 0xc1)
        .put(SetPlayerGameTypePacket.class, (byte) 0xc2)
        .put(PlayerListPacket.class, (byte) 0xc3)
        .put(TelemetryEventPacket.class, (byte) 0xc4)
        .put(SpawnExperienceOrbPacket.class, (byte) 0xc5)
        .put(ClientboundMapItemDataPacket.class, (byte) 0xc6)
        .put(MapInfoRequestPacket.class, (byte) 0xc7)
        .put(RequestChunkRadiusPacket.class, (byte) 0xc8)
        .put(ChunkRadiusUpdatedPacket.class, (byte) 0xc9)
        .put(ItemFrameDropItemPacket.class, (byte) 0xca)
        .put(ReplaceSelectedItemPacket.class, (byte) 0xcb)
        .put(TransferPacket.class, (byte) 0x1b)
        .build();

    ImmutableMap<Class<? extends DataPacket>, Byte> ProtocolInfo84 = ImmutableMap.<Class<? extends DataPacket>, Byte>builder()
        .put(LoginPacket.class, (byte) 0x01)
        .put(PlayStatusPacket.class, (byte) 0x02)
        .put(ServerToClientHandshakePacket.class, (byte) 0x03)
        .put(ClientToServerHandshakePacket.class, (byte) 0x04)
        .put(DisconnectPacket.class, (byte) 0x05)
        .put(BatchPacket.class, (byte) 0x06)
        .put(TextPacket.class, (byte) 0x07)
        .put(SetTimePacket.class, (byte) 0x08)
        .put(StartGamePacket.class, (byte) 0x09)
        .put(AddPlayerPacket.class, (byte) 0x0a)
        .put(AddEntityPacket.class, (byte) 0x0b)
        .put(RemoveEntityPacket.class, (byte) 0x0c)
        .put(AddItemEntityPacket.class, (byte) 0x0d)
        .put(TakeItemEntityPacket.class, (byte) 0x0e)
        .put(MoveEntityAbsolutePacket.class, (byte) 0x0f)
        .put(MovePlayerPacket.class, (byte) 0x10)
        .put(RiderJumpPacket.class, (byte) 0x11)
        .put(RemoveBlockPacket.class, (byte) 0x12)
        .put(UpdateBlockPacket.class, (byte) 0x13)
        .put(AddPaintingPacket.class, (byte) 0x14)
        .put(ExplodePacket.class, (byte) 0x15)
        .put(LevelEventPacket.class, (byte) 0x16)
        .put(BlockEventPacket.class, (byte) 0x17)
        .put(EntityEventPacket.class, (byte) 0x18)
        .put(MobEffectPacket.class, (byte) 0x19)
        .put(UpdateAttributesPacket.class, (byte) 0x1a)
        .put(MobEquipmentPacket.class, (byte) 0x1b)
        .put(MobArmorEquipmentPacket.class, (byte) 0x1c)
        .put(InteractPacket.class, (byte) 0x1e)
        .put(UseItemPacket.class, (byte) 0x1f)
        .put(PlayerActionPacket.class, (byte) 0x20)
        .put(HurtArmorPacket.class, (byte) 0x21)
        .put(SetEntityDataPacket.class, (byte) 0x22)
        .put(SetEntityMotionPacket.class, (byte) 0x23)
        .put(SetEntityLinkPacket.class, (byte) 0x24)
        .put(SetHealthPacket.class, (byte) 0x25)
        .put(SetSpawnPositionPacket.class, (byte) 0x26)
        .put(AnimatePacket.class, (byte) 0x27)
        .put(RespawnPacket.class, (byte) 0x28)
        .put(DropItemPacket.class, (byte) 0x29)
        .put(ContainerOpenPacket.class, (byte) 0x2a)
        .put(ContainerClosePacket.class, (byte) 0x2b)
        .put(ContainerSetSlotPacket.class, (byte) 0x2c)
        .put(ContainerSetDataPacket.class, (byte) 0x2d)
        .put(ContainerSetContentPacket.class, (byte) 0x2e)
        .put(CraftingDataPacket.class, (byte) 0x2f)
        .put(CraftingEventPacket.class, (byte) 0x30)
        .put(AdventureSettingsPacket.class, (byte) 0x31)
        .put(BlockEntityDataPacket.class, (byte) 0x32)
        .put(PlayerInputPacket.class, (byte) 0x33)
        .put(LevelChunkPacket.class, (byte) 0x34)
        .put(SetDifficultyPacket.class, (byte) 0x35)
        .put(ChangeDimensionPacket.class, (byte) 0x36)
        .put(SetPlayerGameTypePacket.class, (byte) 0x37)
        .put(PlayerListPacket.class, (byte) 0x38)
        .put(TelemetryEventPacket.class, (byte) 0x39)
        .put(SpawnExperienceOrbPacket.class, (byte) 0x3a)
        .put(ClientboundMapItemDataPacket.class, (byte) 0x3b)
        .put(MapInfoRequestPacket.class, (byte) 0x3c)
        .put(RequestChunkRadiusPacket.class, (byte) 0x3d)
    ...
    ImmutableMap<Class<? extends DataPacket>, Byte> ProtocolInfo90 = ImmutableMap.<Class<? extends DataPacket>, Byte>builder()
        ...
        .put(DisconnectPacket.class, (byte) 0x05)
        .put(BatchPacket.class, (byte) 0x06)
        .put(ResourcePacksInfoPacket.class, (byte) 0x07)
        .put(ResourcePackStackPacket.class, (byte) 0x08)
        .put(ResourcePackClientResponsePacket.class, (byte) 0x09)
        .put(TextPacket.class, (byte) 0x0a)
        .put(SetTimePacket.class, (byte) 0x0b)
        .put(StartGamePacket.class, (byte) 0x0c)
        .put(AddPlayerPacket.class, (byte) 0x0d)
        ...
        .put(RiderJumpPacket.class, (byte) 0x15)
        .put(RemoveBlockPacket.class, (byte) 0x16)
        .put(UpdateBlockPacket.class, (byte) 0x17)
        .put(AddPaintingPacket.class, (byte) 0x18)
        .put(ExplodePacket.class, (byte) 0x19)
        .put(LevelSoundEventPacket.class, (byte) 0x1a)
        .put(LevelEventPacket.class, (byte) 0x1b)
        .put(BlockEventPacket.class, (byte) 0x1c)
        .put(EntityEventPacket.class, (byte) 0x1d)
        .put(MobEffectPacket.class, (byte) 0x1e)
        .put(UpdateAttributesPacket.class, (byte) 0x1f)
        .put(MobEquipmentPacket.class, (byte) 0x20)
        .put(MobArmorEquipmentPacket.class, (byte) 0x21)
        .put(InteractPacket.class, (byte) 0x22)
        .put(UseItemPacket.class, (byte) 0x23)
        .put(PlayerActionPacket.class, (byte) 0x24)
        .put(HurtArmorPacket.class, (byte) 0x25)
        .put(SetEntityDataPacket.class, (byte) 0x26)
        .put(SetEntityMotionPacket.class, (byte) 0x27)
        .put(SetEntityLinkPacket.class, (byte) 0x28)
        .put(SetHealthPacket.class, (byte) 0x29)
        .put(SetSpawnPositionPacket.class, (byte) 0x2a)
        ...
        .put(ContainerSetDataPacket.class, (byte) 0x32)
        .put(ContainerSetContentPacket.class, (byte) 0x33)
        .put(CraftingDataPacket.class, (byte) 0x34)
        .put(CraftingEventPacket.class, (byte) 0x35)
        .put(AdventureSettingsPacket.class, (byte) 0x36)
        .put(BlockEntityDataPacket.class, (byte) 0x37)
        .put(PlayerInputPacket.class, (byte) 0x38)
        .put(LevelChunkPacket.class, (byte) 0x39)
        .put(SetCommandsEnabledPacket.class, (byte) 0x3a)
        .put(SetDifficultyPacket.class, (byte) 0x3b)
        .put(ChangeDimensionPacket.class, (byte) 0x3c)
        .put(SetPlayerGameTypePacket.class, (byte) 0x3d)
        .put(PlayerListPacket.class, (byte) 0x3e)
        .put(EventPacket.class, (byte) 0x3f)
        .put(SpawnExperienceOrbPacket.class, (byte) 0x40)
        .put(ClientboundMapItemDataPacket.class, (byte) 0x41)
        .put(MapInfoRequestPacket.class, (byte) 0x42)
        .put(RequestChunkRadiusPacket.class, (byte) 0x43)
        .put(ChunkRadiusUpdatedPacket.class, (byte) 0x44)
        .put(ItemFrameDropItemPacket.class, (byte) 0x45)
    ...
    ImmutableMap<Integer, ImmutableMap<Class<? extends DataPacket>, Byte>> oldProtocolInfo = ImmutableMap.<Integer, ImmutableMap<Class<? extends DataPacket>, Byte>>builder()
        .put(v_0_9_5, ProtocolInfo.ProtocolInfo18)
        .put(v_0_10_0, ProtocolInfo.ProtocolInfo18)
        .put(v_0_11_0, ProtocolInfo.ProtocolInfo27)
        .put(v_0_12_1, ProtocolInfo.ProtocolInfo70)
