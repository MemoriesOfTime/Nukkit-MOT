 ...
 * @author LT_Name
 */
public class BlockUpgrader {

    public static CompoundTag upgrade(CompoundTag tag) {
        return upgrade(compoundTag2NbtMap(tag));
    }

    public static CompoundTag upgrade(NbtMap nbtMap) {
        return nbtMap2CompoundTag(BlockStateUpdaters.updateBlockState(nbtMap, nbtMap.getInt("version")));
    }
