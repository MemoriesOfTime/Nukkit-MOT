...
public class Normal extends Generator {
    ...
    private List<Populator> populators = ImmutableList.of(
            new PopulatorOre(STONE, new OreType[]{
                    ...
                    new OreType(Block.get(BlockID.COAL_ORE), Block.get(BlockID.DEEPSLATE_COAL_ORE), 20, 17, 0, 192),
                    new OreType(Block.get(BlockID.COPPER_ORE), Block.get(BlockID.DEEPSLATE_COPPER_ORE), 16, 10, -16, 112),
                    new OreType(Block.get(BlockID.IRON_ORE), Block.get(BlockID.DEEPSLATE_IRON_ORE), 10, 4, -64, 72),
                    new OreType(Block.get(BlockID.IRON_ORE), Block.get(BlockID.DEEPSLATE_IRON_ORE), 10, 9, -24, 56),
                    new OreType(Block.get(BlockID.REDSTONE_ORE), Block.get(BlockID.DEEPSLATE_REDSTONE_ORE), 4, 8, -64, 15),
                    new OreType(Block.get(BlockID.REDSTONE_ORE), Block.get(BlockID.DEEPSLATE_REDSTONE_ORE), 6, 8, -64, -32),
                    new OreType(Block.get(BlockID.LAPIS_ORE), Block.get(BlockID.DEEPSLATE_LAPIS_ORE), 2, 7, -32, 32),
                    new OreType(Block.get(BlockID.LAPIS_ORE), Block.get(BlockID.DEEPSLATE_LAPIS_ORE), 4, 7, -64, 64),
                    new OreType(Block.get(BlockID.GOLD_ORE), Block.get(BlockID.DEEPSLATE_GOLD_ORE), 4, 9, -64, 32),
                    new OreType(Block.get(BlockID.GOLD_ORE), Block.get(BlockID.DEEPSLATE_GOLD_ORE), 1, 9, -64, -48),
                    new OreType(Block.get(BlockID.DIAMOND_ORE), Block.get(BlockID.DEEPSLATE_DIAMOND_ORE), 4, 4, -64, 16),
                    new OreType(Block.get(BlockID.DIAMOND_ORE), Block.get(BlockID.DEEPSLATE_DIAMOND_ORE), 4, 4, -64, 16),
                    new OreType(Block.get(BlockID.DIAMOND_ORE), Block.get(BlockID.DEEPSLATE_DIAMOND_ORE), 2, 8, -64, -4),
                    new OreType(Block.get(BlockID.DIRT), 7, 33, 0, 160),
                    new OreType(Block.get(BlockID.GRAVEL), 11, 33, 0, 256),
                    new OreType(Block.get(BlockID.STONE, BlockStone.GRANITE), 2, 64, 0, 60),
                    new OreType(Block.get(BlockID.STONE, BlockStone.DIORITE), 2, 64, 0, 60),
                    new OreType(Block.get(BlockID.STONE, BlockStone.ANDESITE), 2, 64, 0, 60),
                    new OreType(Block.get(BlockID.TUFF), 2, 64, -64, 0)
            }),
